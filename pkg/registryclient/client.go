...
import (
	...
	types "github.com/common-fate/provider-registry-sdk-go/pkg/providerregistrysdk"
...
func FromConfig(ctx context.Context, cfg *config.Config, opts ...func(co *ClientOpts)) (*types.ClientWithResponses, error) {
	...
	if depCtx.RegistryAPIURL != "" {
		return New(ctx, depCtx.RegistryAPIURL, cfg.CurrentContext, opts...)
	}
	...
	return New(ctx, exp.RegistryAPIURL, cfg.CurrentContext, opts...)
}
