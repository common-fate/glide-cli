...
type LoginOpts struct {
	// Keyring allows a custom keyring to be used for logging in.
	Keyring keyring.Keyring
}

func WithKeyring(k keyring.Keyring) func(*LoginOpts) {
	return func(lo *LoginOpts) {
		lo.Keyring = k
	}
}

func Login(opts ...func(*LoginOpts)) *cli.Command {
	var o LoginOpts
